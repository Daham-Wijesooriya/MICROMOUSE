...
target_sources(${PROJECT_NAME} PRIVATE
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/Core/Src/io_selftest.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/Core/Src/motor_pwm.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/Core/Src/motor_test.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/Core/Startup/startup_stm32f405rgtx.s"
...
configure_file("${CMAKE_CURRENT_SOURCE_DIR}/STM32F405RGTX_FLASH.ld" "${CMAKE_CURRENT_BINARY_DIR}" COPYONLY)

set_target_properties(${PROJECT_NAME} PROPERTIES LINK_DEPENDS "${CMAKE_CURRENT_BINARY_DIR}/STM32F405RGTX_FLASH.ld")
